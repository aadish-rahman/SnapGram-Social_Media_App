...
const Profile = () => {
  ...
  const { mutate, isPending: isToggleFollowLoading } = useToggleFollowUser();
              ...
              <div className="flex gap-5 mt-4">
                {userData.$id !== currentUser!.id && (
                  <Button
                    ...
                    disabled={isToggleFollowLoading} // Disable button while loading
                  ...
                  >
                    {isToggleFollowLoading ? ( // Render loading indicator if loading
                      <Loader size="sm" />
                    ) : (
                      followButtonLabel
                    )}
